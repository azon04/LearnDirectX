...
bool LightMapShaderClass::Initialize(ID3D11Device* device, HWND hWnd)
{
	...
	result = InitializeShader(device, hWnd, L"./Shaders/LightMap_Vertex.hlsl", L"./Shaders/LightMap_Pixel.hlsl");
	if (!result)
	{
		return false;
	}
...
bool LightMapShaderClass::InitializeShader(ID3D11Device* device, HWND hWnd, WCHAR* vsFileName, WCHAR* psFileName)
{
	...
	result = D3DX11CompileFromFile(vsFileName, NULL, NULL, "LightMapVertexShader", "vs_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0, NULL,
	...
	result = D3DX11CompileFromFile(psFileName, NULL, NULL, "LightMapPixelShader", "ps_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0, NULL,
