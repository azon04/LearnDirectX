...
void FrustumClass::ConstructFrustum(float screenDepth, D3DXMATRIX projectionMatrix, D3DXMATRIX viewMatrix)
{
	...
	// Calculat the frustum matrix from the view matrix and updated projection matrix
	D3DXMatrixMultiply(&matrix, &viewMatrix, &projectionMatrix);

	// Calculate near place of frustum
	...
	// Calculate far place of frustum
	...
	// Calculate left place of frustum
	...
	// Calculate right place of frustum
	...
	// Calculate bott0m plane of frustum
...
{
	// Check if the point is inside all six planes of the view fustrum
	for (int i = 0; i < 6; i++)
	{
...
bool FrustumClass::CheckCube(float xCenter, float yCenter, float zCenter, float radius)
{
	...
	// This might be failed if the cube is bigger than frustum, or e.g we look closer to the cube
	for (int i = 0; i < 6; i++)
	{
