...
bool FontShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	bool result = InitializeShader(device, hwnd, L"./Shaders/Font_Vertex.hlsl", L"./Shaders/Font_Pixel.hlsl");
	return result;
}
...
bool FontShaderClass::Render(ID3D11DeviceContext* deviceContex, int indexCount, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix, D3DXMATRIX projectionMatrix, ID3D11ShaderResourceView* textureResource, D3DXVECTOR4 pixelColor)
{
	// Set the shader parameters that it will use for rendering
	bool result = SetShaderParameters(deviceContex, worldMatrix, viewMatrix, projectionMatrix, textureResource, pixelColor);
	if (!result)
	{
		return false;
	}
...
bool FontShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFileName, WCHAR* psFileName)
{
	...
	// Setup description of the dynamic pixel contant buffer that is in the pixel shader
...
bool FontShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix, 
	D3DXMATRIX projectionMatrix, ID3D11ShaderResourceView* textureResource, D3DXVECTOR4 pixelColor)
{
	HRESULT result;
	...
	// Lock the pixel constant buffer so ti can be written to
	...
	// Set position of the pixel constant buffer in the pixel shader
	bufferNumber = 0;
